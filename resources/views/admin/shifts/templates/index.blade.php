...
@section('title', __('shifts.templates.title'))
...
<div class="shifts-templates-page" x-data="shiftsTemplatesData()">
    ...
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-header-left">
                <h1 class="page-title">{{ __('shifts.templates.title') }}</h1>
                <p class="page-description">{{ __('shifts.templates.subtitle') }}</p>
            </div>
            <div class="page-header-right">
                <div class="header-actions">
                    <button class="btn btn-secondary" @click="showImportModal = true">
                        ...
                        {{ __('shifts.templates.import_template') }}
                    </button>
                    <a href="{{ route('admin.shifts.templates.create') }}" class="btn btn-primary">
                        <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
                        {{ __('shifts.templates.create_template') }}
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="summary-grid">
            <div class="summary-card summary-card-primary">
                ...
                <div class="summary-content">
                    ...
                    <div class="summary-label">{{ __('shifts.templates.total_templates') }}</div>
                </div>
            </div>
            ...
            <div class="summary-card summary-card-success">
                ...
                <div class="summary-content">
                    ...
                    <div class="summary-label">{{ __('shifts.templates.active_templates') }}</div>
                </div>
            </div>
            ...
            <div class="summary-card summary-card-warning">
                ...
                <div class="summary-content">
                    ...
                    <div class="summary-label">{{ __('shifts.templates.draft_templates') }}</div>
                </div>
            </div>
            ...
            <div class="summary-card summary-card-info">
                ...
                <div class="summary-content">
                    ...
                    <div class="summary-label">{{ __('shifts.templates.total_applications') }}</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="template-types-section">
        <div class="section-header">
            <h2 class="section-title">{{ __('shifts.templates.template_types') }}</h2>
        </div>
        <div class="template-types-grid">
            ...
            <div class="template-type-card">
                <div class="type-header">
                    ...
                    <span class="type-count">{{ $data['count'] }} {{ __('shifts.templates.templates') }}</span>
                </div>
                <div class="type-stats">
                    <div class="stat-item">
                        <span class="stat-value">{{ $data['total_usage'] }}</span>
                        <span class="stat-label">{{ __('shifts.templates.times_used') }}</span>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="quick-access-grid">
        ...
        <div class="popular-templates-section">
            <div class="section-header">
                <h3 class="section-title">{{ __('shifts.templates.popular_templates') }}</h3>
                <a href="#all-templates" class="view-all-link">{{ __('shifts.templates.view_all') }}</a>
            </div>
                ...
                <div class="template-quick-card">
                    <div class="template-info">
                        ...
                        <div class="template-meta">
                            <span class="usage-count">{{ $template['usage_count'] }} {{ __('shifts.templates.uses') }}</span>
                    ...
                    <div class="template-actions">
                        <button class="btn btn-sm btn-primary" @click="showApplyModal({{ json_encode($template) }})">
                            {{ __('shifts.templates.apply_template') }}
                        </button>
                    </div>
                </div>
                @endforeach
        ...
        <div class="recent-templates-section">
            <div class="section-header">
                <h3 class="section-title">{{ __('shifts.templates.recent_templates') }}</h3>
                <a href="#all-templates" class="view-all-link">{{ __('shifts.templates.view_all') }}</a>
            </div>
            <div class="templates-quick-list">
                ...
                <div class="template-quick-card">
                    <div class="template-info">
                        ...
                        <div class="template-meta">
                            ...
                            <span class="created-by">{{ __('shifts.templates.by') }} {{ $template['created_by'] }}</span>
                        </div>
                    </div>
                    <div class="template-actions">
    ...
    <div class="all-templates-section" id="all-templates">
        <div class="section-header">
            <h2 class="section-title">{{ __('shifts.templates.all_templates') }}</h2>
            <div class="section-filters">
                <select x-model="filterType" @change="applyFilters()" class="filter-select">
                    <option value="all">{{ __('shifts.templates.all_types') }}</option>
                    <option value="weekly">{{ __('shifts.templates.weekly') }}</option>
                    <option value="weekend">{{ __('shifts.templates.weekend') }}</option>
                    <option value="special">{{ __('shifts.templates.special') }}</option>
                    <option value="minimal">{{ __('shifts.templates.minimal') }}</option>
                    <option value="training">{{ __('shifts.templates.training') }}</option>
                </select>
                ...
                <input type="text" x-model="searchQuery" @input="applyFilters()" class="search-input" placeholder="{{ __('shifts.templates.search_templates') }}">
            </div>
        </div>
        ...
        <div class="templates-grid">
            ...
            <div class="template-card" data-type="{{ $template['type'] }}" data-status="{{ $template['status'] }}" data-name="{{ strtolower($template['name']) }}">
                <div class="template-card-header">
                    ...
                    <div class="template-menu" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition class="menu-dropdown">
                            <a href="{{ route('admin.shifts.templates.edit', $template['id']) }}" class="menu-item">
                ...
                <div class="template-stats">
                    <div class="stats-grid">
                        <div class="stat-item">
                            ...
                            <span class="stat-label">{{ __('shifts.common.shifts') }}</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-value">{{ $template['total_staff_required'] }}</span>
                            <span class="stat-label">{{ __('shifts.common.staff') }}</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-value">${{ number_format($template['estimated_cost']) }}</span>
                            <span class="stat-label">{{ __('shifts.templates.estimated_cost') }}</span>
                        </div>
                        <div class="stat-item">
                            <span class="stat-value">{{ $template['usage_count'] }}</span>
                            <span class="stat-label">{{ __('shifts.templates.uses') }}</span>
                        </div>
                    </div>
                </div>

                <div class="template-shifts-preview">
                    <h4 class="preview-title">{{ __('shifts.templates.shifts_included') }}</h4>
                    <div class="shifts-preview-list">
                        ...
                        <div class="more-shifts">
                            +{{ count($template['shifts']) - 3 }} {{ __('shifts.templates.more_shifts') }}
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="template-meta">
                    <div class="meta-info">
                        <span class="created-by">{{ __('shifts.templates.created_by') }} {{ $template['created_by'] }}</span>
                        <span class="created-date">{{ $template['created_at']->format('M d, Y') }}</span>
                        @if($template['last_used'])
                        <span class="last-used">{{ __('shifts.templates.last_used') }} {{ $template['last_used']->diffForHumans() }}</span>
                        @endif
                    </div>
                </div>
    ...
    <div x-show="showApplyTemplateModal" x-transition class="modal-overlay" @click.self="showApplyTemplateModal = false">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">{{ __('shifts.templates.apply_template') }}</h3>
            ...
            <div class="modal-body">
                <div class="template-summary" x-show="selectedTemplate">
                    <h4>{{ __('shifts.templates.template_details') }}</h4>
                    <div class="template-info-grid">
                        <div class="info-item">
                            <span class="info-label">{{ __('shifts.templates.template_name') }}</span>
                            <span class="info-value" x-text="selectedTemplate?.name"></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">{{ __('shifts.common.type') }}</span>
                            <span class="info-value" x-text="selectedTemplate?.type"></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">{{ __('shifts.templates.total_shifts') }}</span>
                            <span class="info-value" x-text="selectedTemplate?.total_shifts"></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">{{ __('shifts.templates.estimated_cost') }}</span>
                ...
                <div class="application-settings">
                    <h4>{{ __('shifts.templates.application_settings') }}</h4>
                    <div class="settings-grid">
                        <div class="form-group">
                            <label class="form-label">{{ __('shifts.templates.start_date') }}</label>
                            <input type="date" x-model="applicationSettings.startDate" class="form-input">
                        </div>
                        <div class="form-group">
                            <label class="form-label">{{ __('shifts.templates.end_date') }}</label>
                        ...
                        <div class="form-group form-group-full">
                            <label class="form-checkbox">
                                ...
                                <span class="checkbox-label">{{ __('shifts.templates.overwrite_existing') }}</span>
                            </label>
                            <div class="form-help">{{ __('shifts.templates.overwrite_help') }}</div>
                        </div>
                    </div>
                </div>

                <div class="preview-section" x-show="applicationPreview">
                    <h4>{{ __('shifts.templates.application_preview') }}</h4>
                    <div class="preview-stats">
                        <div class="preview-stat">
                            <span class="stat-value" x-text="applicationPreview?.total_shifts"></span>
                            <span class="stat-label">{{ __('shifts.templates.shifts_to_create') }}</span>
                        </div>
                        <div class="preview-stat">
                            <span class="stat-value" x-text="applicationPreview?.weeks_affected"></span>
                            <span class="stat-label">{{ __('shifts.templates.weeks_affected') }}</span>
                        </div>
                        <div class="preview-stat">
                            <span class="stat-value" x-text="formatCurrency(applicationPreview?.estimated_cost)"></span>
                            <span class="stat-label">{{ __('shifts.templates.total_cost') }}</span>
                        </div>
                    </div>
            ...
            <div class="modal-actions">
                <button class="btn btn-secondary" @click="generatePreview()">
                    {{ __('shifts.templates.preview_application') }}
                </button>
