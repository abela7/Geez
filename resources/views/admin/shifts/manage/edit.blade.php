...
@section('title', __('shifts.manage.edit_shift'))

@section('content')
<div class="shift-edit-page" x-data="shiftEditData({{ json_encode($shift) }})">
    <!-- Page Header -->
    <div class="page-header">
        <div class="page-header-content">
            <div class="page-header-left">
                <h1 class="page-title">{{ __('shifts.manage.edit_shift') }}</h1>
                <p class="page-description">{{ __('shifts.manage.edit_description') }}</p>
            </div>
            <div class="page-header-right">
                <div class="header-actions">
                    ...
                    <button class="btn btn-secondary" @click="duplicateShift()">
                        <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
