...
@section('title', __('admin.shift_types.edit_title'))
...
<div class="shift-types-page">
        ...
        <div class="page-header-content">
            <div class="page-title-section">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-current">{{ __('admin.shift_types.edit') }} {{ $shiftType->name }}</span>
                </div>
                <h1 class="page-title">{{ __('admin.shift_types.edit_title') }}</h1>
                <p class="page-subtitle">{{ __('admin.shift_types.edit_description') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="shift-types-form-section">
        <form action="{{ route('admin.settings.shift-types.update', $shiftType) }}" method="POST" class="form-layout">
            @csrf
            @method('PUT')
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="3"
                                  placeholder="{{ __('admin.shift_types.description_placeholder') }}">{{ old('description', $shiftType->description) }}</textarea>
                        @error('description')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="color-input-container">
                            <input type="color" 
                                   ...
                                   value="{{ old('color', $shiftType->color) }}" 
                                   required>
                            <input type="text" 
                                   id="color-text" 
                                   name="color_text" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('sort_order', $shiftType->sort_order) }}" 
                               min="0" 
                               step="1">
                        @error('sort_order')
                            <div class="form-error">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="currency-input-container">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('default_hourly_rate', $shiftType->default_hourly_rate) }}" 
                                   min="0" 
                                   max="999.99" 
                                   step="0.01">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="currency-input-container">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('default_overtime_rate', $shiftType->default_overtime_rate) }}" 
                                   min="0" 
                                   max="999.99" 
                                   step="0.01">
                        </div>
                ...
                <div class="form-group">
                    <label class="checkbox-label">
                        <input type="checkbox" 
                               ...
                               {{ old('is_active', $shiftType->is_active) ? 'checked' : '' }}>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary">
                    {{ __('admin.shift_types.update_shift_type') }}
                </button>
            </div>
        </form>
    </div>
