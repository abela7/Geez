...
@section('title', __('admin.departments.create_title') . ' - ' . config('app.name'))
@section('page_title', __('admin.departments.create_title'))
...
<div class="departments-page">
        ...
        <div class="page-header-content">
            <div class="page-title-section">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-current">{{ __('admin.departments.create_new') }}</span>
                </div>
                <h1 class="page-title">{{ __('admin.departments.create_title') }}</h1>
                <p class="page-subtitle">{{ __('admin.departments.create_description') }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="departments-form-section">
        <form action="{{ route('admin.settings.departments.store') }}" method="POST" class="form-layout">
            @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group form-group-full">
                        ...
                        <textarea id="description" 
                                  ...
                                  rows="3"
                                  placeholder="{{ __('admin.departments.description_placeholder') }}">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="form-error">{{ $message }}</div>
                        @enderror
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary">
                    ...
                    {{ __('admin.departments.create_department') }}
                </button>
            </div>
        </form>
    </div>
