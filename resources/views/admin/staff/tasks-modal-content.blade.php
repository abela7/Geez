            ...
            @foreach($task->assignments as $assignment)
                <div class="assignment-card">
                    ...
                    <div class="assignment-meta">
                        ...
                        @if($assignment->status === 'completed' && $assignment->hasQualityRating())
                            <div class="meta-item">
                                <svg class="meta-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span style="color: {{ $assignment->quality_rating_color }}">{{ $assignment->quality_rating_display }} quality</span>
                            </div>
                        @endif
                    </div>
                </div>
